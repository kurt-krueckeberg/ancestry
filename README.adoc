...
sphinx-book-theme
sphinx_external_toc that allows easier conversion of Antora navigation.

== Custom Javascript Needed

In source/static, create `clickable-images.js`:
...
project = 'Krückeberg Research and Ancestry'
...
external_toc_exclude_missing = True # exclude .md files not listing in the
`_toc.yml` file.
